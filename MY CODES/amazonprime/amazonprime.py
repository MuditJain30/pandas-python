...
def submenu3():
    ...
    while ch1!=4:
        ...
        print('2.DISPLAY DETAILS OF TOP 3 AMAZON PRIME SERIES')
        print('3.DISPLAY DETAILS OF BOTTOM 3 AMAZON PRIME SERIES')
        ...
        if ch1==1:
            ...
            print('details of 3 Amazon Prime Series with highest imdb rating')
            print(df.sort_values('imdbRating',ascending=False).head(3))
        elif ch1==3:
            print('details of 3 Amazon Prime Series with lowest imdb rating')
...
def mainmenu():
    ...
    while True:
        print('\n---------------------------------------------------')
        print(' AMAZON PRIME DATA-MAIN MENU                         ')
        print('---------------------------------------------------')
...
def submenu2():
    ...
    while ch2!=3:
        ...
        print('---------------------------------------------------')
        print('1.LINE GRAPH:RATING OF WEB SERIES')
        ...
        if ch2==1:
            ...
            plt.title('WEB SERIES ',fontsize=20)
            plt.show()
        elif ch2==2:
            f=pd.DataFrame(df)
            a=f.loc[:,'Title']
